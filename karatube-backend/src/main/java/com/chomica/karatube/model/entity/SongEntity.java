...
@Entity
@Table(name = "song")
public class SongEntity implements IEntity {
   // ---------------------------------------------------------------
   ...
   // ---------------------------------------------------------------
   public SongEntity() { }
   public SongEntity(String id, String name, int category, SingerEntity singer, String tubeId, int confirmed, Long createTime, Long lastUpdateTime) {
      this.id = id;
      this.name = name;
